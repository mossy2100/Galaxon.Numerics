...
/// same for each billit in the significand.
///
/// Mantissa
/// ========
/// 4 bytes (1 int). Note, this is not a power of 10 but a power of B.
/// The decimal mantissa equals the value stored in the byte (the billesimal mantissa) * 9.
/// The billesimal exponent range is -2,147,483,648 to 2,147,483,647, which corresponds to a decimal
...
/// [-]9.999.. * 10^[-]999.. (or [-]9.999..e[-]9.999..) except the base is billesimal, i.e. the
/// value is found from
...
public class Gigadecimal : IEquatable<Gigadecimal>, IComparable<Gigadecimal>
{
    ...
    // protected Gigadecimal(int length, int mantissa = 0)
    // {
    ...
    /// </summary>
    public Gigadecimal(int[]? significand = null, int mantissa = 0)
    {
        if (significand == null)
        {
    ...
    public static Gigadecimal Clone(Gigadecimal bd) =>
    ...
    public override bool Equals(object? obj) =>
        obj is Gigadecimal bd && Equals(bd);
    ...
    /// <param name="bd"></param>
    /// <returns></returns>
    public static Gigadecimal Negate(Gigadecimal bd)
    {
    ...
    /// <param name="bd"></param>
    /// <returns></returns>
    public static Gigadecimal operator -(Gigadecimal bd) =>
        Negate(bd);

    public static Gigadecimal Add(Gigadecimal bd1, Gigadecimal bd2)
    {
        // Optimizations.
        if (bd1.IsZero)
        {
    ...
    public static Gigadecimal operator +(Gigadecimal bd1, Gigadecimal bd2) =>
        Add(bd1, bd2);

    public static Gigadecimal Subtract(Gigadecimal bd1, Gigadecimal bd2) =>
        Add(bd1, -bd2);

    public static Gigadecimal operator -(Gigadecimal bd1, Gigadecimal bd2) =>
        Subtract(bd1, bd2);

    public static Gigadecimal Multiply(Gigadecimal bd1, Gigadecimal bd2)
    {
        // Optimizations.
    ...
    public static Gigadecimal Divide(Gigadecimal numerator, Gigadecimal denominator)
    {
        ...
        return new Gigadecimal(n.Significand, n.Mantissa + resultMantissa);
    }
    ...
    /// <param name="bd"></param>
    /// <returns></returns>
    public static Gigadecimal Reciprocal(Gigadecimal bd) =>
        Divide(One(), bd);
    ...
    public static Gigadecimal FromUInt64(ulong l)
    {
        ...
        return new Gigadecimal(billits.ToArray(), billits.Count - 1);
    }
    ...
    public static Gigadecimal FromDecimal(decimal d)
    {
        ...
        Gigadecimal bd = new (billits, mantissa);
    ...
    /// </exception>
    public static decimal ToDecimal(Gigadecimal bd)
    {
        decimal m = 0;
        decimal scale = 0;
    ...
    /// </exception>
    public static double ToDouble(Gigadecimal bd) =>
    ...
    public static explicit operator decimal(Gigadecimal bd) =>
        ToDecimal(bd);

    public static implicit operator Gigadecimal(double d) =>
        FromDouble(d);

    public static explicit operator double(Gigadecimal bd) =>
        ToDouble(bd);
    ...
    public static Gigadecimal Round(Gigadecimal bd)
    {
        int[] significand = bd.Significand;
        int mantissa = bd.Mantissa;
        significand = Round(significand, ref mantissa);
        return new Gigadecimal(significand, mantissa);
    }
